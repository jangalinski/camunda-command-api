 ...
 */
interface UseCaseFormService {

  /**
   * Retrieves all data necessary for rendering a form to start a new process instance. This can be used to perform rendering of the forms
   * outside of the process engine.
   *
   ...
   * practice.
   *
   * Note that a business key MUST be unique for the given process definition. Process instance from different process definition are
   * allowed to have the same business key.
   *
   * @param processDefinitionId the id of the process definition, cannot be null.
   * @param businessKey a key that uniquely identifies the process instance in the context or the given process definition.
  ...
  /**
   * Retrieves all data necessary for rendering a form to complete a task. This can be used to perform rendering of the forms outside of the
   * process engine.
   *
   ...
   * no {@link ProcessDefinitionPermissions#READ_TASK_VARIABLE} permission on {@link Resources#PROCESS_DEFINITION} when {@link
   * ProcessEngineConfiguration#enforceSpecificVariablePermission this} config is enabled</li>
   * </ul></p>
   */
   ...
   * <li>if the user has {@link TaskPermissions#READ_VARIABLE} permission on {@link Resources#TASK} or
   * no {@link ProcessDefinitionPermissions#READ_TASK_VARIABLE} permission on {@link Resources#PROCESS_DEFINITION} when {@link
   * ProcessEngineConfiguration#enforceSpecificVariablePermission this} config is enabled</li></p>
   */
   ...
   * Permissions#UPDATE_TASK} permission on {@link Resources#PROCESS_DEFINITION}.
   */
  ...
  /**
   * Retrieves a list of all variables for rendering a start from. The method takes into account FormData specified for the start event.
  ...
  /**
   * Retrieves a list of requested variables for rendering a start from. The method takes into account FormData specified for the start
   * event. This allows defining default values for form fields.
   *
   * @param processDefinitionId the id of the process definition for which the start form should be retrieved.
   ...
   *
   * In the Explorer app, it is assumed that the form key specifies a resource in the deployment, which is the template for the form.  But
   * users are free to use this property differently.
   *
   * @throws AuthorizationException If the user has no {@link Permissions#READ} permission on {@link Resources#PROCESS_DEFINITION}.
   */
