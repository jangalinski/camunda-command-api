 ...
 */
interface UseCaseFilterService {
   ...
   * @throws BadUserRequestException <ul><li>When the filter query uses expressions and expression evaluation is deactivated for stored
   * queries. Expression evaluation can be activated by setting the process engine configuration properties
   ...
   * the process engine configuration property <code>queryMaxResultsLimit</code> (default {@link Integer#MAX_VALUE}). Please use {@link
   * #listPage(String, int, int)} instead.
   */
   ...
   * <li>When a maximum results limit is specified. A maximum results limit can be specified with
   * the process engine configuration property <code>queryMaxResultsLimit</code> (default {@link Integer#MAX_VALUE}). Please use {@link
   * #listPage(String, Query, int, int)} instead.
   */
   ...
   * be specified with the process engine configuration property <code>queryMaxResultsLimit</code> (default {@link Integer#MAX_VALUE}).
   */
