 ...
 * @author Joram Barrez
 */
interface UseCaseRepositoryService {
  ...
  /**
   * Deletes the process definition which belongs to the given process definition id. Same behavior as {@link
   * UseCaseRepositoryService#deleteProcessDefinition(String, boolean, boolean)} Both boolean parameters of this method are per default
   * false. The deletion is in this case not cascading.
   *
   ...
   * @see UseCaseRepositoryService#deleteProcessDefinition(String, boolean, boolean)
   */
  void deleteProcessDefinition(String processDefinitionId);

  /**
   * Deletes the process definition which belongs to the given process definition id. Cascades the deletion if the cascade is set to true.
   * Same behavior as {@link UseCaseRepositoryService#deleteProcessDefinition(String, boolean, boolean)} The skipCustomListeners parameter
   * is per default false. The custom listeners are called if the cascading flag is set to true and the process instances are deleted.
   *
   * @param processDefinitionId the id, which corresponds to the process definition
   * @param cascade if set to true, all process instances (including) history are deleted
   * @throws ProcessEngineException If the process definition does not exist
  ...
  /**
   * Deletes the process definition which belongs to the given process definition id. Cascades the deletion if the cascade is set to true
   * the custom listener can be skipped if the third parameter is set to true.
   *
   * @param processDefinitionId the id, which corresponds to the process definition
   * @param cascade if set to true, all process instances (including) history are deleted
   * @param skipCustomListeners if true, only the built-in {@link ExecutionListener}s are notified with the {@link
   * ExecutionListener#EVENTNAME_END} event. Is only used if cascade set to true.
   * @throws ProcessEngineException If the process definition does not exist
   * @throws AuthorizationException If the user has no {@link Permissions#DELETE} permission on {@link Resources#PROCESS_DEFINITION}.
   */
  ...
  /**
   * Deletes the process definition which belongs to the given process definition id. Cascades the deletion if the cascade is set to true,
   * the custom listener can be skipped if the third parameter is set to true, io mappings can be skipped if the forth parameter is set to
   * true.
   *
   * @param processDefinitionId the id, which corresponds to the process definition
   * @param cascade if set to true, all process instances (including) history are deleted
   ...
   * @throws ProcessEngineException When the resource doesn't exist in the given deployment or when no deployment exists for the given
   * deploymentId.
   * @throws AuthorizationException If the user has no {@link Permissions#READ} permission on {@link Resources#DEPLOYMENT}.
   */
   ...
   * @param suspensionDate The date on which the process definition will be suspended. If null, the process definition is suspended
   * immediately. Note: The job executor needs to be active to use this!
   * @throws ProcessEngineException If no such processDefinition can be found.
   * @throws AuthorizationException <li>If the user has no {@link Permissions#UPDATE} permission on {@link
   ...
   * <p>Note: for more complex activate commands use {@link #updateProcessDefinitionSuspensionState()}.</p>
   *
   * @param suspendProcessInstances If true, all the process instances of the provided process definition will be activated too.
   * @param activationDate The date on which the process definition will be activated. If null, the process definition is suspended
   * immediately. Note: The job executor needs to be active to use this!
   * @throws ProcessEngineException If no such processDefinition can be found.
   * @throws AuthorizationException <li>If the user has no {@link Permissions#UPDATE} permission on {@link
   * Resources#PROCESS_DEFINITION}.</li>
  ...
  /**
   * Activate or suspend process definitions using a fluent builder. Specify the definitions by calling one of the <i>by</i> methods, like
   * <i>byProcessDefinitionId</i>. To update the suspension state call
   * {@link UpdateProcessDefinitionSuspensionStateBuilder#activate()} or {@link UpdateProcessDefinitionSuspensionStateBuilder#suspend()}.
   *
  ...
  /**
   * Provides positions and dimensions of elements in a process diagram as provided by {@link UseCaseRepositoryService#getProcessDiagram(String)}.
   *
   ...
   *
   * @param processDefinitionId the id of the Process Definition for which the {@link BpmnModelInstance} should be retrieved.
   ...
   *
   * @param caseDefinitionId the id of the Case Definition for which the {@link CmmnModelInstance} should be retrieved.
   ...
   * @throws NotFoundException when no CMMN model instance or deployment resource is found for the given case definition id
   ...
   *
   * @param decisionDefinitionId the id of the Decision Definition for which the {@link DmnModelInstance} should be retrieved.
   ...
   * @throws NotFoundException when no DMN model instance or deployment resource is found for the given decision definition id
   * @throws ProcessEngineException when an internal exception happens during the execution of the command.
  ...
  /**
   * Retrieves the {@link IdentityLink}s associated with the given process definition. Such an {@link IdentityLink} informs how a certain
   * identity (eg. group or user) is authorized for a certain process definition
   *
   * @deprecated Use authorization mechanism instead.
   */
  @Deprecated
   ...
   * @throws ProcessEngineException when an internal exception happens during the execution of the command.
   * @throws AuthorizationException If the user has no {@link Permissions#READ} permission on {@link
   ...
   * @throws NotFoundException when no decision requirements definition or deployment resource is found for the given decision requirements
   * definition id
   * @throws ProcessEngineException when an internal exception happens during the execution of the command
   * @throws AuthorizationException If the user has no {@link Permissions#READ} permission on {@link
   * Resources#DECISION_REQUIREMENTS_DEFINITION}.
